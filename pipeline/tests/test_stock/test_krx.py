...
class TestStockList:
    ...
    def test_fetch(self, mock_request):
        ...
        mock_response.json.return_value = {'OutBlock_1': [{'ISU_CD': 'KR7005930003', 'ISU_NM': '삼성전자'}]}
...
class TestStockPrice:
    ...
    def test_fetch(self, mock_request):
        ...
        mock_instance = mock_request.return_value
        mock_response = MagicMock()
        mock_response.json.return_value = {'OutBlock_1': [{'ISU_SRT_CD': '005930', 'TDD_CLSPRC': '70,000'}]}
        mock_instance.post.return_value = mock_response
    ...
    def test_transform(self, stock_price_data):
        ...
        # 1. 함수 실행
        stock_price = StockPrice()
        result = stock_price.transform(stock_price_data, params={'get_date': '20230101'})
    ...
    def test_load(self, mock_db_connection, stock_price_data):
        ...
        transformed_data = stock_price.transform(stock_price_data, params={'get_date': '20230101'})
